...
<?php
	...
	echo  "<div class='filter_div'>"
        ."Search in attendance<br/><div class='input-append'>"
	.form_input($data).form_submit('attendance/search','search','class=btn btn-primary')
        ."</div></div>";
        //including list table file
        $this -> load -> view('attendance/list_table');       
